...
export const BOOKS: Book[] = [
  {
    ...
    description: 'A recipe-based book to help you efficiently create amazing PHP-based applicationswith Laravel 5.x',
  ...
  },
  {
    ...
    description: 'Over 70 incredibly effective and practical recipes to get you up and running wi Sitecore development',
