export class ApiConfig {
    ...
    private static fileServer: string = '//localhost:3000/';
    public static mediaPath: string = 'http://localhost:3000/api/Containers/images/files';
    private static defaultMediaUploadPath: string = 'http://localhost:3000/api/Containers/images/upload';
